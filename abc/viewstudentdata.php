<html>
	...
	<form action="confirmpay.php" method="POST" onsubmit="return check(this);">
	...
	<tr>
		<td colspan="2" align="center">
			...
			<a href="denypayment.php?mobile=<?php echo $row['clgid']; ?>" onclick="return check2(this);"><input type="button" value="Deny Payment" class="btn btn-warning"></a>&nbsp&nbsp&nbsp
			
			<input type="submit" value="Confirm Payment"  class="btn btn-success">
		<a href="deletedata.php?mobile=<?php echo $row['clgid']; ?>" onclick="return del(this);" class="btn btn-danger">Delete</a>
			
			<a href="confirmid.php?mobile=<?php echo $row['clgid']; ?>" onclick="return check1(this);"><input type="button" value="confirm id" class="btn btn-success"></a>
			<a href="denyid.php?mobile=<?php echo $row['clgid']; ?>" onclick="return check3(this);"><input type="button" value="Deny id" class="btn btn-warning"></a>
			</td>
			</tr>
	</table>
	</form>
