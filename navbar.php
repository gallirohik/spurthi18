...
<div class="w3-top">
  <div class="w3-bar w3-teal w3-card">
	...
	<a href="attractions/" class="w3-bar-item w3-button w3-padding-large w3-hide-small">ATTRACTIONS</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
	<a href="index.php?id=1" class="w3-bar-item w3-button w3-padding-large">EVENTS</a>
    <a href="http://spurthi18.com/attractions/" class="w3-bar-item w3-button w3-padding-large">ATTRACTIONS</a>
	...
	<a href="team.php" class="w3-bar-item w3-button w3-padding-large">OUR TEAM</a>
