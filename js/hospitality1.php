  ...
  <div class="w3-row">
    ...
    <div class="w3-padding-16"><span class="w3-xlarge w3-border-teal w3-bottombar">Contact Us</span></div>
      ...
      <p>For more queries,feel free to contact</p>
         <div class="w3-half">	       
		   <h3>Boys</h3>
      <p><i class="fa fa-user w3-text-teal w3-xlarge"></i>  Uma Nagendra</p>
      <p><i class="fa fa-phone w3-text-teal w3-xlarge"></i>  +91 8332024999</p>
